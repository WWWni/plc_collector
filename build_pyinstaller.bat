...
set OUTPUT_DIR=%~dp0dist\PLC_Collector_PyInstaller
...
echo   Build OK!
echo.
echo   Output: dist\PLC_Collector_PyInstaller\
echo.
echo     monitor_app.exe   - PLC Collector (PyInstaller)
echo     config.yaml       - Default config
echo     _internal\        - Runtime deps
echo.
echo   Zip the dist\PLC_Collector_PyInstaller folder to distribute.
echo ============================================================
pause
